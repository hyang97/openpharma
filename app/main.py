...
async def send_message_stream(request: UserRequest):
    ...
    async def event_generator():
        ...
        try:
            ...
            chunks = semantic_search(request.user_message, request.top_k, request.top_n, request.additional_chunks_per_doc)
            # chunks = hybrid_retrieval(request.user_message, conversation_history, request.top_k, request.top_n, request.additional_chunks_per_doc)
