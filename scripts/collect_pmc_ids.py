...
Examples:
  ...
  python scripts/collect_pmc_ids.py --limit 50

  # Collect all oncology papers from 2023-2024
  python scripts/collect_pmc_ids.py --keyword cancer --start-date 2023-01-01 --end-date 2024-12-31

  # Find papers updated in February 2025
  python scripts/collect_pmc_ids.py --start-date 2025-02-01 --end-date 2025-02-28 --date-field lr

  # Use custom query for specific publication types (e.g., meta-analyses, reviews)
  python scripts/collect_pmc_ids.py --query "diabetes[MeSH] AND meta-analysis[ptyp] AND open access[filter]"
